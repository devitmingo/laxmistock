...
<div class="page-content">
    ...
    <div class="page-title">
        <h5><i class="fa fa-align-justify"></i> {{ isset($data) ? 'Edit' : 'Add' }} Supplier Payment</h5>
    </div>
    <!-- /page title -->
    ...
    <!-- Advanced form components -->
        ...
        <div class="panel panel-default">
            <div class="panel-heading"><h6 class="panel-title">{{ isset($data) ? 'Edit' : 'Add' }} Supplier Payment</h6></div>
            ...
            @endif
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input class="form-control" type="hidden" name="page" value="{{ old('page',isset($data->page) ? $data->page : '5' ) }}">
