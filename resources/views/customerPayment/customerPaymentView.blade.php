...
<div class="page-content">
    ...
    <div class="page-title">
        <h5><i class="fa fa-table"></i>CUSTOMER PAYMENT </h5>        
    </div>
    <!-- /page title -->
    ...
    <ul class="row stats">
        ...
        <li class="col-xs-3">
            <a href="{{ route('customerPayment') }}" class="btn btn-info">ADD NEW CUSTOMER PAYMENT</a>
        </li>
    </ul>
    <!-- /statistics -->
...
<x-alert/>
    ...
    <div class="panel panel-default">
        <div class="panel-heading"><h6 class="panel-title">Customer Payments</h6></div>
