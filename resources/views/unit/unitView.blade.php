...
<div class="page-content">
    ...
    <ul class="row stats">
        ...
        <li class="col-xs-3">
            <a href="{{ route('unit.create') }}" class="btn btn-info">ADD NEW UNIT</a>
        </li>
    </ul>
    <!-- /statistics -->
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{route('unit.edit',$row->id)}}" class="btn btn-default btn-icon btn-xs tip" rel="tooltip" title="Edit">
