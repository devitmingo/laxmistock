...
<div class="page-content">
    ...
    <div class="page-title">
        <h5><i class="fa fa-table"></i> HEAD </h5>        
    </div>
    <!-- /page title -->
    ...
    <ul class="row stats">
        ...
        <li class="col-xs-3">
            <a href="{{ route('head.create') }}" class="btn btn-info">ADD NEW HEAD</a>
        </li>
    </ul>
    <!-- /statistics -->
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{route('head.edit',$row->id)}}" class="btn btn-default btn-icon btn-xs tip" rel="tooltip" title="Edit">
                            <i class="fa fa-pencil"></i>
                            </a>
                            
                            <a href="#" class="btn" rel="tooltip" title="Delete">
                                                                
                                <form action="{{route('head.destroy',$row->id)}}" method="post">
                                    @csrf
                                    @method('delete')
