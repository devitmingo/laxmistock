...
#bg-text
{
    ...
    -webkit-transform:rotate(300deg);
            ...
            <table  style="width: 100%">
                ...
                <tr>
                    <th colspan="4" style="text-align:center;"> Supplier Name : {{ $purchase->party->name }}</th>
                    <th colspan="5" style="text-align:center;"> Bill Date : {{ date('d-m-y',strtotime($purchase->date)) }}</th>
                </tr>
                ...
                @php $grandTotal=0; @endphp
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;">{{ number_format($row->buyRate,2) }}</td>
